...
var bingNewsSearchV7 = function (_commonService) {
    _inherits(bingNewsSearchV7, _commonService);
     ...
     */
    function bingNewsSearchV7(_ref) {
        var apiKey = _ref.apiKey;

        _classCallCheck(this, bingNewsSearchV7);
    ...
    */
    ...
    bingNewsSearchV7.prototype.categoryNews = function categoryNews(_ref2) {
        ...
        var operation = {
            ...
            "parameters": this.parameters.filter(function (p) {
                return p.name == 'cc' || p.name == 'category' || p.name == 'count' || p.name == 'freshness' || p.name == 'headlineCount' || p.name == 'mkt' || p.name == 'offset' || p.name == 'q' || p.name == 'safeSearch' || p.name == 'setLang' || p.name == 'since' || p.name == 'sortBy' || p.name == 'textDecorations' || p.name == 'textFormat';
            })
        };
    ...
    Example Parameters: {
        ...
        @returns {Promise.<object>}
    */
    bingNewsSearchV7.prototype.search = function search(_ref3) {
        ...
        var operation = {
            ...
            "headers": this.headers,
            "parameters": this.parameters.filter(function (p) {
                return p.name == 'cc' || p.name == 'count' || p.name == 'freshness' || p.name == 'mkt' || p.name == 'offset' || p.name == 'originalImg' || p.name == 'q' || p.name == 'safeSearch' || p.name == 'setLang' || p.name == 'since' || p.name == 'sortBy' || p.name == 'textDecorations' || p.name == 'textFormat';
            })
        };
    ...
    @returns {Promise.<object>}
    */
    bingNewsSearchV7.prototype.trendingTopics = function trendingTopics(_ref4) {
        ...
        var operation = {
            ...
            "headers": this.headers,
            "parameters": this.parameters.filter(function (p) {
                return p.name == 'cc' || p.name == 'count' || p.name == 'mkt' || p.name == 'offset' || p.name == 'safeSearch' || p.name == 'setLang' || p.name == 'since' || p.name == 'sortBy' || p.name == 'textDecorations' || p.name == 'textFormat';
            })
        };

...
[23:26:18] Using gulpfile ~\Documents\GitHub\node-cognitive-services\gulpfile.js
[23:26:18] Starting 'pre-test'...
[23:26:18] Finished 'pre-test' after 841 ms
[23:26:18] Starting 'test'...
  ...
  Academic knowledge
    ...
    Evaluate Post
      √ should return response (136ms)
    GraphSearch
      1) should return response
    Interpret
      √ should return response (146ms)
    Interpret Post
      √ should return response (142ms)
    Get similarity
      √ should return response (199ms)
    Post similarity
      √ should return response (177ms)

  QnA maker
Generating knowledge base...
    Download knowledge base
      √ should return response (287ms)
    Generate answer
      √ should return response (1057ms)
    Get alterations
      √ should return response (603ms)
    Publish knowledge base
      √ should return response (1457ms)
    Train knowledge base
      √ should return response (640ms)
    Update alterations
      √ should return response (805ms)
    Update knowledge base
      √ should return response (4842ms)
...
Generating knowledge base...
  ...
  Language understanding (LUIS)
    Delete app after
      √ should import app (14332ms)
      √ should add prebuilt domain (11312ms)
    Create app before, delete app after
      √ should detect Intent from ENDPOINT (2267ms)
      √ should get list of LUIS applications (2381ms)
      √ should get list of LUIS assistants (2279ms)
      √ should get list of LUIS domains (2254ms)
      √ should get list of LUIS usage scenarios (2238ms)
      √ should get list of LUIS cultures (2231ms)
      3) should get list of LUIS custom prebuilt domains
      4) should get list of LUIS custom prebuilt domains for each supported culture
      √ should return array with endpoint queries for this APP (2353ms)
      √ should get APP (2600ms)
      √ should update APP name (2393ms)
      √ should update APP settings (2867ms)
      √ should get APP endpoints (2269ms)
      √ should get APP querylogs (2286ms)
      √ should get APP settings (2240ms)
      √ should get APP permissions (2257ms)
      √ should add email to permissions to APP (2326ms)
      √ should update APP permissions (2370ms)
      √ should delete APP permissions (6889ms)
      5) should return application version in JSON for this VERSION
      √ should get list of example labeled utterances for this VERSION (3002ms)
      √ should get list of entities in this VERSION (2276ms)
      √ should get list of intents in VERSION (2301ms)
      6) should get APP versions
      √ should clone VERSION (16102ms)
      7) should get app VERSION info
      √  should get VERSION features (2634ms)
      √  should get VERSION HIERARCHICALENTITIES (2346ms)
      √  should get VERSION LISTPREBUILTS (2292ms)
      √  should get VERSION models (2676ms)
      √  should post VERSION closedlists (2633ms)

  Text analytics
    Detect language (POST)
      √ should return response (206ms)
    Key phrases (POST)
      √ should return response (241ms)
    Sentiment (POST)
      √ should return response (220ms)
    Link entity
      √ should return response (190ms)

  Text translator
    translate array
      √ should return response (763ms)
      √ should mark profan words when auto-detecting language (173ms)
    translate
      √ should return response (136ms)
    get language names
      √ should return response (154ms)
    get languages for translate
      √ should return response (158ms)
    get languages for speak
      √ should return response (213ms)
    speak
      √ should return response (216ms)
    detect
      √ should return response (89ms)
    detect array
      √ should return response (119ms)
    break sentences
      √ should return response (124ms)
    get translations
      √ should return response (196ms)
    get translations array
      √ should return response (312ms)

  Bing speech
    Speech to text
      √ should get text (1267ms)
    Text to speech
      √ should get speech (547ms)

  Speaker identification
Creating identification profile...
    √ should get one profile (244ms)
    √ should get all profiles (251ms)
Enrolling identification profile...
    √ should enroll one time and get operation status (3308ms)
    √ should get operation id from identification (639ms)
Deleting enrollmments...
Deleting identification profile...

  Speaker verification
Creating verification profile...
    √ should get one profile (240ms)
    √ should get all profiles (366ms)
Creating 3 enrollments...
    √ should enroll three times and then verify (5331ms)
    √ should list all verification phrases (166ms)
Deleting enrollmments...
Deleting verification profile...

  Bing autosuggest
    Suggestions
      √ should return response (285ms)

  Bing autosuggest v7
    Suggestions
      √ should return response (252ms)
  ...
  Bing Image Search
    Search
      √ should get image insights (824ms)
      √ should get results for a query (782ms)
      √ should get trending images (327ms)

  Bing Image Search v7
    Image Insights
      √ should get image insights (1098ms)
    search
      √ should get results for a query (694ms)
    trending images
      √ should get response (360ms)

  Bing news search
    News by category
      √ should return response (295ms)
    Search
      √ should return response (588ms)
    Trending news
      √ should return response (384ms)

  Bing news search v7
    News by category
      √ should return response (279ms)
    Search
      √ should return response (492ms)
    Trending news
      √ should return response (297ms)

  Bing video search
    Search
      √ should return response (719ms)
    Trending
      √ should return response (460ms)
    Details
      √ should return response (485ms)

  Bing video search v7
    Search
      √ should return response (467ms)
    Trending
      √ should return response (360ms)
    Details
      √ should return response (417ms)

  Bing web search
    Search
      √ should return response (630ms)

  Bing web search v7
    Search
      √ should return response (524ms)

  Computer vision
    Analyze Image (POST)
      √ should accept application/json (2069ms)
      √ should accept application/octet-stream (683ms)
    Describe image (POST)
      √ should accept application/json (1886ms)
    Get thumbnail (POST)
      √ should accept application/json (881ms)
    List domain specific models (GET)
      √ should return list (230ms)
    Recognize domain specific content (POST)
      √ should accept application/json (1548ms)
    Tag images (POST)
      √ should accept application/json (471ms)
    Recognize handwritten text (POST and GET)
      √ should accept application/octet-stream (2193ms)
    OCR (POST)
      √ should accept application/json (385ms)
      √ should accept file (1528ms)

  Content moderator
    Detect language in text
      √ should return response (228ms)
    Screen text
      √ should return response (319ms)
    Evaluate image
      √ should return response when image is sent in body (425ms)
      √ should return response when image is sent in JSON url (632ms)
    Get faces from image
      √ should return response when image is sent in body (299ms)
      √ should return response when image is sent in JSON url (1019ms)
    OCR
      √ should return response when image is sent in JSON url (472ms)
    Image Lists
Creating image list...
Adding image to list...
      √ should get list details (220ms)
      √ should refresh search index (299ms)
      √ should update list details (355ms)
      √ should get all image lists (238ms)
      √ should get all image IDs from a list (282ms)
      √ should delete image from list (413ms)
      √ should match against an image list (530ms)
Deleting all images from list...
Deleting image list...
    Terms Lists
Creating term list...
Adding term to list...
      √ should get term list details (160ms)
      √ should refresh search index (297ms)
      √ should update term list details (1547ms)
      √ should get all term lists (172ms)
      √ should get all terms from a list (238ms)
      √ should delete term from list (236ms)
      √ should try to match term against list (816ms)
Deleting all terms from list...
Deleting term list...

  Emotion
    Recognize emotion (POST)
      √ should return response (259ms)
    Recognize emotion with face rectangles (POST)
      √ should return response (273ms)

  Face
    Face
      √ should detect when body is in json format (268ms)
      √ should detect when body is in binary (427ms)
      √ should find similar (176ms)
      √ should group faces (196ms)
      √ should verify faces (194ms)
    Face list
      √ should get a face list, list them all (353ms)
      √ should add a face to the face list and delete it (794ms)
      √ should update a face list (221ms)
    Large face list
      √ should get a large face list, list them all (569ms)
      √ should add a face to the large face list, get it and delete it (842ms)
      √ should add a face to the large face list and update it and list it (878ms)
      √ should list faces in a large face list (802ms)
      √ should update a large face list (218ms)
      √ should train a large face list and get training status (422ms)
    Person
      √ should add a person face with a picture in a URL (392ms)
      √ should add a person face with a binary image (327ms)
      √ should update a person (289ms)
    Person group
      √ should get a person group, and list them all (637ms)
      √ should update a person group (218ms)
      √ should train a person group and get training status (410ms)
      √ should list persons in a person group (480ms)
undefined
...
Uploading video...
  ...
  1) Academic knowledge GraphSearch should return response:
     StatusCodeError: 500 - {"statusCode":500,"message":"Internal server error","activityId":"b84a1cc4-17d8-4d37-a22d-ac763e1b9155"}
  ...
  2) QnA maker v4 "before all" hook:
  ...
  3) Language understanding (LUIS) Create app before, delete app after should get list of LUIS custom prebuilt domains:
  ...
  4) Language understanding (LUIS) Create app before, delete app after should get list of LUIS custom prebuilt domains for each supported culture:
     AssertionError: expected Array [
  Object {
    name: 'Calendar',
    culture: 'en-us',
  ...
  5) Language understanding (LUIS) Create app before, delete app after should return application version in JSON for this VERSION:
     AssertionError: expected Object {
  luis_schema_version: '3.1.0',
  versionId: '0.1',
  name: 'mocha-1539671311322',
  ...
  settings: Array []
} to have only keys luis_schema_version, versionId, name, desc, culture, intents, entities, composites, closedLists, regex_entities, model_features, regex_features, utterances
    expected Object {
      luis_schema_version: '3.1.0',
      versionId: '0.1',
      name: 'mocha-1539671311322',
  ...
  6) Language understanding (LUIS) Create app before, delete app after should get APP versions:
  ...
  7) Language understanding (LUIS) Create app before, delete app after should get app VERSION info:
     AssertionError: expected Array [] to have property length of 3 (got 0)
      at Assertion.fail (node_modules\should\cjs\should.js:275:17)
      at Assertion.value (node_modules\should\cjs\should.js:356:19)
  ...
  8) Bing entity search Get entities should return response:
  ...
  9) Video indexer Upload video in body "before all" hook:
  ...
  10) Video indexer Accounts should get accounts:
     RequestError: Error: getaddrinfo ENOTFOUND videobreakdown.azure-api.net videobreakdown.azure-api.net:443
      at new RequestError (node_modules\request-promise-core\lib\errors.js:14:15)
      at Request.plumbing.callback (node_modules\request-promise-core\lib\plumbing.js:87:29)
      at Request.RP$callback [as _callback] (node_modules\request-promise-core\lib\plumbing.js:46:31)
  ...
  11) Video indexer Search should search:
     RequestError: Error: getaddrinfo ENOTFOUND videobreakdown.azure-api.net videobreakdown.azure-api.net:443
      at new RequestError (node_modules\request-promise-core\lib\errors.js:14:15)
      at Request.plumbing.callback (node_modules\request-promise-core\lib\plumbing.js:87:29)
      at Request.RP$callback [as _callback] (node_modules\request-promise-core\lib\plumbing.js:46:31)
